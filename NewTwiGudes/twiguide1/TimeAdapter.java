...
public class TimeAdapter extends BaseAdapter implements Filterable {
    ...
    public TimeAdapter(Context context, ArrayList<Time> originalArray) {
    ...
    public void update(ArrayList<Time> results){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        textView.setText(originalArray.get(position).getEnglishTime());
        textView1.setText(originalArray.get(position).getTwiTime());
  ...
  /*  @Override
    public Filter getFilter() {
        if (cf==null){
            cf = new TimeAdapter.CustomFilter();
        }
