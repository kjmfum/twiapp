...
public class HomeAdapter extends BaseAdapter implements Filterable {
    ...
    Context context;
    ArrayList<HomeButton> originalArray , tempArray;
    //TimeAdapter.CustomFilter cf;

    public HomeAdapter(Context context, ArrayList<HomeButton> originalArray) {
    ...
    public void update(ArrayList<HomeButton> results){
