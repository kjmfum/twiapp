...
public class SubConversationDirections extends AppCompatActivity {

    // static ArrayList<subConversation> conversationWelcomingOthersArrayList;
    static ArrayList<subConversation> conversationDirections;
    Handler handler1;
    Runnable ranable;
    int count= 0;
    long delayTime=3000;
    ...
    RecyclerView familyRecyclerView;
        ...
        public boolean onCreateOptionsMenu(Menu menu) {
            ...
            searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
                ...
                public boolean onQueryTextChange(String newText) {
                    ...
                    for (subConversation x: conversationDirections ){
        ...
        public void downloadClick () {
            ...
            for (int j = 0; j < conversationDirections.size(); j++) {


                bb = conversationDirections.get(j).getTwiConversation();
            ...
            if (counter == conversationDirections.size()) {
                ...
                if (isNetworkAvailable()) {
                    ...
                    for (int i = 0; i < conversationDirections.size(); i++) {

                        bb = conversationDirections.get(i).getTwiConversation();
                        bb = PlayFromFirebase.viewTextConvert(bb);
    ...
    public void previous (View view){
        ...
        String c = conversationDirections.get(count).getTwiConversation();
        String a = conversationDirections.get(count).getEnglishConversation();
    ...
    public void next(View view){
        ...
        if (count>= conversationDirections.size()-1){
            count = conversationDirections.size()-1;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            if(1<5) {
                ...
                ranable = new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (repeat1) {
                            ...
                            String a = conversationDirections.get(count).getTwiConversation();
                            String c = conversationDirections.get(count).getEnglishConversation();
                ...
                nextButton.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        if (count <= conversationDirections.size()) {
                            next(v);
                        }
                ...
                btStartSlideShow.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (unMuted){
                            ...
                            muteButton.setVisibility(View.INVISIBLE);
                            unmuteButton.setVisibility(View.VISIBLE);
                            Toast.makeText(SubConversationDirections.this, "Sound Muted", Toast.LENGTH_SHORT).show();
                        }
            ...
            subConversationAdapter subConversationAdapter = new subConversationAdapter(this, conversationDirections);
