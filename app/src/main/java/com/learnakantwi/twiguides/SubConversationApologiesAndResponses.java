...
public class SubConversationApologiesAndResponses extends AppCompatActivity {


    static ArrayList<subConversation> conversationsApologiesArrayList;
    Handler handler1;
    Runnable ranable;
    int count= 0;
    long delayTime=3000;
    ...
    RecyclerView familyRecyclerView;
        ...
        public boolean onCreateOptionsMenu(Menu menu) {
            ...
            searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
                ...
                public boolean onQueryTextChange(String newText) {
                    ...
                    for (subConversation x: conversationsApologiesArrayList ){
        ...
        public void downloadClick () {
            ...
            for (int j = 0; j < conversationsApologiesArrayList.size(); j++) {


                bb = conversationsApologiesArrayList.get(j).getTwiConversation();
            ...
            if (counter == conversationsApologiesArrayList.size()) {
                ...
                if (isNetworkAvailable()) {
                    ...
                    for (int i = 0; i < conversationsApologiesArrayList.size(); i++) {

                        bb = conversationsApologiesArrayList.get(i).getTwiConversation();
                        bb = PlayFromFirebase.viewTextConvert(bb);
    ...
    public void previous (View view){
        ...
        String c = conversationsApologiesArrayList.get(count).getTwiConversation();
        String a = conversationsApologiesArrayList.get(count).getEnglishConversation();
    ...
    public void next(View view){
        ...
        if (count>=conversationsApologiesArrayList.size()-1){
            count = conversationsApologiesArrayList.size()-1;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            if(1<5) {
                ...
                ranable = new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (repeat1) {
                            ...
                            String a = conversationsApologiesArrayList.get(count).getTwiConversation();
                            String c = conversationsApologiesArrayList.get(count).getEnglishConversation();
                ...
                nextButton.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        if (count <= conversationsApologiesArrayList.size()) {
                            next(v);
                        }
                ...
                btStartSlideShow.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (unMuted){
                            ...
                            muteButton.setVisibility(View.INVISIBLE);
                            unmuteButton.setVisibility(View.VISIBLE);
                            Toast.makeText(SubConversationApologiesAndResponses.this, "Sound Muted", Toast.LENGTH_SHORT).show();
                        }
            ...
            subConversationAdapter subConversationAdapter = new subConversationAdapter(this, conversationsApologiesArrayList);
            ...
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    String Test = conversationsApologiesArrayList.get(position).getEnglishConversation();
