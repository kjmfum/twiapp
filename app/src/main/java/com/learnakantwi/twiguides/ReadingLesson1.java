...
public class ReadingLesson1 extends AppCompatActivity implements LessonsAdapter.onClickRecycle{



   public static  ArrayList<Lessons> lesson;
...
*/
 ...
 /*   toast= Toast.makeText(this, "", Toast.LENGTH_SHORT);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lesson.add(new Lessons("Ata ba ha", "Ata comes here"));
        lesson.add(new Lessons("Papa ba ha", "Papa comes here"));
        lesson.add(new Lessons("Mama ba ha", "Mama comes here"));
        lesson.add(new Lessons("Papa fa ahaban no", "Papa takes the leaf"));
        lesson.add(new Lessons("Mama fa ahaban no", "Mama takes the leaf"));
        lesson.add(new Lessons("Papa fa adaka no", "Papa takes the box"));
        lesson.add(new Lessons("Dada fa abaa no", "Dada takes the stick"));
        lesson.add(new Lessons("Mama fa safoa no", "Mama takes the key"));
        lesson.add(new Lessons("Mama da ha na Ama nso da ha", "Mama sleeps here and Ama also sleep here"));
        lesson.add(new Lessons("Papa saw na Ata saw", "Papa dances and Ata dances"));
        lesson.add(new Lessons("Papa tam mango no", "Papa carries the mango"));
