...
import static com.learnakantwi.twiguides.SubConversationGratitude.conversationGratitude;
...
public class SubPHomeMainActivity extends AppCompatActivity implements PurchasesUpdatedListener, RVHomeMainAdapter.onClickRecycle {
   ...
   static ArrayList<subConversation> conversationAll;
    ...
    public void testing(View v){
       ...
       String test = "";
     /*  if (SignUpActivity.userLocal.getEmail() == null){
           test="I am null o";
       }
       else{
           test = SignUpActivity.userLocal.getEmail();
       }*/
...
//  correct      homeListView = findViewById(R.id.homeListView);
...

        {
            ...
            if (5 > 2) {
                ...
                conversationDirections.add(new subConversation("W'adu Accra", "You have arrived at Accra"));
        ...
        //conversationGratitude = new ArrayList<>(); 4 December 2020
       // conversationGratitude.add(new subConversation("", ""));
        conversationGratitude = new ArrayList<>();
        conversationGratitude.add(new subConversation("Meda wo ase", "Thank You (1)"));
        conversationGratitude.add(new subConversation("Medaase", "Thank You (2)"));
        conversationGratitude.add(new subConversation("Awurade nhyira wo", "May the Lord bless you"));
        conversationGratitude.add(new subConversation("Me da wo ase sɛ wo aboa me", "I thank you for helping me"));
        conversationGratitude.add(new subConversation("Mede nnaase a enni kabea ma wo", "I give you thanks that cannot be quantified"));
        conversationGratitude.add(new subConversation("Meda wo ase paa ara", "I thank you very much"));
        conversationGratitude.add(new subConversation("M'ani sɔ nea woayɛ ama me no pa ara", "I am very grateful to you for what you have done for me"));
        conversationGratitude.add(new subConversation("Wo aboa me paa", "You have really helped me"));
        conversationGratitude.add(new subConversation("Wei deɛ minhu nea menka mpo", "As for this I don't even know what to say"));
        conversationGratitude.add(new subConversation("Wo yam ye paa", "You are very kind (Lit: Your stomach is very good)"));
        conversationGratitude.add(new subConversation("Mentumi nna w'ase nwie", "I can't thank you enough (Lit: I can't finish thanking you)"));
        conversationGratitude.add(new subConversation("Mede wo aseda ka", "I owe you a thank you"));
        conversationGratitude.add(new subConversation("Me nso me da wo ase", "I also thank you(1)"));
        conversationGratitude.add(new subConversation("Me nso medaase", "I also thank you(2)"));
        conversationGratitude.add(new subConversation("Yɛmfa aseda mma Onyankopɔn", "Let's give thanks to God"));
        conversationGratitude.add(new subConversation("Awurade na ayɛ", "It is the Lord who has done it"));
        conversationGratitude.add(new subConversation("Oh ɛnyɛ hwee", "Oh it's nothing"));
        conversationGratitude.add(new subConversation("Ɛnha wo ho", "Don't worry yourself"));
        conversationGratitude.add(new subConversation("Ɛnna ase", "Don't thank me/Don't mention it"));
        conversationGratitude.add(new subConversation("Yoo", "Okay"));
   
        {
            conversationAll = new ArrayList<>();
            conversationAll.addAll(conversationArrayList);
            conversationAll.addAll(conversationGratitude);
            conversationAll.addAll(conversationWelcomingOthersArrayList);
            conversationAll.addAll(conversationPhone);
            conversationAll.addAll(conversationLove);
            conversationAll.addAll(conversationsApologiesArrayList);
            conversationAll.addAll(conversationDirections);
            conversationAll.addAll(conversationHospital);
        ...
        if (mAuth.getCurrentUser()!=null){
           ...
           // Toast.makeText(this, User.isEmailVerified() +": okay", Toast.LENGTH_SHORT).show();
            ...
            if (User.isEmailVerified()){
                ...
                stringBuilder.append("Click to verify your email: ").append(currentUserEmail);
                Map<String, Boolean> verified = new HashMap<>();
