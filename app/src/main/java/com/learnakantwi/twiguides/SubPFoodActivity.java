...
public class SubPFoodActivity extends AppCompatActivity implements FoodAdapter.onClickRecycle {
    ...
    int count= 0;
    String textSlideshow = "Start Food Slideshow";
    int ArraySize = foodArrayList.size();
