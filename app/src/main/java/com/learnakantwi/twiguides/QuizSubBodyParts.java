...
public class QuizSubBodyParts extends AppCompatActivity {
    ...
    int chosenSize=(bodypartsArrayList.size()-1);
    ...
    public void generateQuestion(){
        ...
        randomChoiceQuestion = random.nextInt(bodypartsArrayList.size()-1);
        english1 = bodypartsArrayList.get(randomChoiceQuestion).getEnglishBodyparts();

        questionText.setText(english1);

        twi1 = bodypartsArrayList.get(randomChoiceQuestion).getTwiBodyparts();
        ...
        for (int i = 0; i < 4;i++ ){
            ...
            if (i== answerLocation){
                ...
                while (bodypartsArrayList.get(chosenSizeRand).getTwiBodyparts().equals(twi1) || bodypartsArrayList.get(chosenSizeRand).getEnglishBodyparts().contains("(")){
                    chosenSizeRand = random.nextInt(chosenSize);}
                answers.add(bodypartsArrayList.get(chosenSizeRand).getTwiBodyparts());
