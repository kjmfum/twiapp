...
public class QuizSubColours extends AppCompatActivity {
    ...
    int chosenSize=(coloursArrayList.size()-1);
    ...
    public void generateQuestion(){
        ...
        randomChoiceQuestion = random.nextInt(coloursArrayList.size()-1);
        english1 = coloursArrayList.get(randomChoiceQuestion).getEnglishColours();

        questionText.setText(english1);

        twi1 = coloursArrayList.get(randomChoiceQuestion).getTwiColours();
        ...
        for (int i = 0; i < 4;i++ ){
            ...
            if (i== answerLocation){
                ...
                while (coloursArrayList.get(chosenSizeRand).getTwiColours().equals(twi1) || coloursArrayList.get(chosenSizeRand).getEnglishColours().contains("(")){
                    chosenSizeRand = random.nextInt(chosenSize);}
                answers.add(coloursArrayList.get(chosenSizeRand).getTwiColours());
