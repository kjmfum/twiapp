...
public class ConversationMainAdapter extends BaseAdapter implements Filterable {

    Context context;
    ArrayList<String> originalArray , tempArray;
    //CustomFilter cf;

    public ConversationMainAdapter(Context context, ArrayList<String> originalArray) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       ...
       // TextView textView = convertView.findViewById(R.id.tvReadingAdapter);
        ...
        textView1.setText(originalArray.get(position));
