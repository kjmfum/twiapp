...
public class SubConversationHospital extends AppCompatActivity {
    ...
    static ArrayList<subConversation> conversationHospital;
    Handler handler1;
    Runnable ranable;
    int count= 0;
    long delayTime=3000;
    ...
    RecyclerView familyRecyclerView;
        ...
        public boolean onCreateOptionsMenu(Menu menu) {
            ...
            searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
                ...
                public boolean onQueryTextChange(String newText) {
                    ...
                    for (subConversation x: conversationHospital ){
        ...
        public void downloadClick () {
            ...
            for (int j = 0; j < conversationHospital.size(); j++) {


                bb = conversationHospital.get(j).getTwiConversation();
            ...
            if (counter == conversationHospital.size()) {
                ...
                if (isNetworkAvailable()) {
                    ...
                    for (int i = 0; i < conversationHospital.size(); i++) {

                        bb = conversationHospital.get(i).getTwiConversation();
                        bb = PlayFromFirebase.viewTextConvert(bb);
    ...
    public void previous (View view){
        ...
        String c = conversationHospital.get(count).getTwiConversation();
        String a = conversationHospital.get(count).getEnglishConversation();
    ...
    public void next(View view){
        ...
        if (count>=conversationHospital.size()-1){
            count = conversationHospital.size()-1;
                ...
                ranable = new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (repeat1) {
                            ...
                            String a = conversationHospital.get(count).getTwiConversation();
                            String c = conversationHospital.get(count).getEnglishConversation();
...
/////
                ...
                nextButton.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        if (count <= conversationHospital.size()) {
                            next(v);
                        }
...
////
                        if (unMuted){
                            ...
                            muteButton.setVisibility(View.INVISIBLE);
                            unmuteButton.setVisibility(View.VISIBLE);
                            Toast.makeText(SubConversationHospital.this, "Sound Muted", Toast.LENGTH_SHORT).show();
                        }
            ...
            subConversationAdapter subConversationAdapter = new subConversationAdapter(this, conversationHospital);
