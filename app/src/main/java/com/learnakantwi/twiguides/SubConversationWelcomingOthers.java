...
public class SubConversationWelcomingOthers extends AppCompatActivity {
    ...
    ////
        ...
        public boolean onCreateOptionsMenu(Menu menu) {
            ...
            searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
                ...
                public boolean onQueryTextChange(String newText) {
                    ...
                    for (subConversation x: conversationWelcomingOthersArrayList ){
        ...
        public void downloadClick () {
            ...
            for (int j = 0; j < conversationWelcomingOthersArrayList.size(); j++) {


                bb = conversationWelcomingOthersArrayList.get(j).getTwiConversation();
            ...
            if (counter == conversationWelcomingOthersArrayList.size()) {
                ...
                if (isNetworkAvailable()) {
                    ...
                    for (int i = 0; i < conversationWelcomingOthersArrayList.size(); i++) {

                        bb = conversationWelcomingOthersArrayList.get(i).getTwiConversation();
                        bb = PlayFromFirebase.viewTextConvert(bb);
    ...
    public void previous (View view){
        ...
        String c = conversationWelcomingOthersArrayList.get(count).getTwiConversation();
        String a = conversationWelcomingOthersArrayList.get(count).getEnglishConversation();
    ...
    public void next(View view){
        ...
        if (count>=conversationWelcomingOthersArrayList.size()-1){
            count = conversationWelcomingOthersArrayList.size()-1;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            if(1<5) {
                ...
                ranable = new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (repeat1) {
                            ...
                            String a = conversationWelcomingOthersArrayList.get(count).getTwiConversation();
                            String c = conversationWelcomingOthersArrayList.get(count).getEnglishConversation();
                ...
                nextButton.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        if (count <= conversationWelcomingOthersArrayList.size()) {
                           // System.out.println("Mee " + familyArrayList.size() + ": " + count);
                            next(v);
                        }
                ...
                btStartSlideShow.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (unMuted){
                            ...
                            muteButton.setVisibility(View.INVISIBLE);
                            unmuteButton.setVisibility(View.VISIBLE);
                            Toast.makeText(SubConversationWelcomingOthers.this, "Sound Muted", Toast.LENGTH_SHORT).show();
                        }
            ...
            subConversationAdapter subConversationAdapter = new subConversationAdapter(this, conversationWelcomingOthersArrayList);
            ...
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    String Test = conversationWelcomingOthersArrayList.get(position).getEnglishConversation();
