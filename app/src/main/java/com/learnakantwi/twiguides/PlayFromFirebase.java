...
public class PlayFromFirebase {
    ...
    private MediaPlayer playFromDevice;
    private MediaPlayer mp1;

    public PlayFromFirebase(String a){
        allClick(a);
    }

    public PlayFromFirebase() {
    }
        ...
        if (myFile.exists()){
            ...
            try {
                ...
                playFromDevice.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
                    ...
                    public void onPrepared(MediaPlayer mp) {
                        mp.start();
                       // Toast.makeText(context.getApplicationContext(), appearText, Toast.LENGTH_SHORT).show();
        ...
        if (isNetworkAvailable()) {
            Runnable runnable = new Runnable() {
                ...
                public void run() {
                    ...
                    request.setDestinationInExternalFilesDir(context.getApplicationContext(), Environment.DIRECTORY_MUSIC, filename + fileExtension);
