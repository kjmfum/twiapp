...
public class SubPVerbActivity extends AppCompatActivity implements VerbAdapter_one.onClickRecycle {



    static ArrayList<Verb> verbArrayList;
   ...
   // FamilyAdapter_one foodAdapter;
    VerbAdapter_one foodAdapter;
    //ArrayList<Family> recycleArrayList;
    ArrayList<Verb> recycleArrayList;
   ...
   /* public boolean hasInternetAccess() {
    ...
    public void downloadClick () {
        ...
        if (isNetworkAvailable()) {
            for (int j = 0; j < verbArrayList.size(); j++) {



                String c = verbArrayList.get(j).getTwiVerb().toLowerCase();
            ...
            if (counter == verbArrayList.size()) {
                ...
                for (int i = 0; i < verbArrayList.size(); i++) {
                    String c = verbArrayList.get(i).getTwiVerb().toLowerCase();
    ...
    public void previous (View view){
        ...
        String c = verbArrayList.get(count).getTwiVerb();
        String a = verbArrayList.get(count).getEnglishVerb();
    ...
    public void next(View view){
        ...
        if (count>=verbArrayList.size()-1){
            count = verbArrayList.size()-1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvStartSlideShow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (tvStartSlideShow.getText().toString().toLowerCase().contains("end")){
                    ...
                    tvStartSlideShow.setText("Start Verb Slideshow");
                    foodListView.setVisibility(View.VISIBLE);
                    tvStartSlideShow.setVisibility(View.VISIBLE);
                    btSlideText.setVisibility(View.INVISIBLE);
                    tvNumberWord.setVisibility(View.INVISIBLE);
        ...
        recycleArrayList.addAll(verbArrayList);

        foodAdapter = new VerbAdapter_one(this, recycleArrayList, this);
    ...
    public void onMyItemClick(int position, View view) {
        String b = recycleArrayList.get(position).getTwiVerb();

        b = PlayFromFirebase.viewTextConvert(b);

        String a = recycleArrayList.get(position).getEnglishVerb()+" is: "+ recycleArrayList.get(position).getTwiVerb();
