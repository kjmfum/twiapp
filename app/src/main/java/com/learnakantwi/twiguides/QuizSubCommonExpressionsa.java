...
public class QuizSubCommonExpressionsa extends AppCompatActivity {
    ...
    int chosenSize=(commonExpressionsAArrayList.size()-1);
    ...
    public void generateQuestion(){
        ...
        randomChoiceQuestion = random.nextInt(commonExpressionsAArrayList.size()-1);
        english1 = commonExpressionsAArrayList.get(randomChoiceQuestion).getEnglishCommonExpressionsA();

        questionText.setText(english1);

        twi1 = commonExpressionsAArrayList.get(randomChoiceQuestion).getTwiCommonExpressionsA();
        ...
        for (int i = 0; i < 4;i++ ){
            ...
            if (i== answerLocation){
                ...
                while (commonExpressionsAArrayList.get(chosenSizeRand).getTwiCommonExpressionsA().equals(twi1) || commonExpressionsAArrayList.get(chosenSizeRand).getEnglishCommonExpressionsA().contains("(")){
                    chosenSizeRand = random.nextInt(chosenSize);}
                answers.add(commonExpressionsAArrayList.get(chosenSizeRand).getTwiCommonExpressionsA());
