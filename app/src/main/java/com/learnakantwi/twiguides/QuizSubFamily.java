...
public class QuizSubFamily extends AppCompatActivity {
    ...
    int chosenSize=(familyArrayList.size()-1);
    ...
    public void generateQuestion(View v){
        ...
        english1 = familyArrayList.get(randomChoiceQuestion).getEnglishFamily();

        questionText.setText(english1);

        twi1 = familyArrayList.get(randomChoiceQuestion).getTwiFamily();
        ...
        for (int i = 0; i < 4;i++ ){
            ...
            if (i== answerLocation){
                ...
                while (familyArrayList.get(chosenSizeRand).getTwiFamily().equals(twi1)
                ) {
                    chosenSizeRand = random.nextInt(chosenSize);
                    // answers.add(allArrayList.get(chosenSize).getTwiMain());
                }

                answers.add(familyArrayList.get(chosenSizeRand).getTwiFamily());
            }
    ...
    public void generateQuestion(){
        ...
        randomChoiceQuestion = random.nextInt(familyArrayList.size()-1);
        english1 = familyArrayList.get(randomChoiceQuestion).getEnglishFamily();
        ...
        for (int i = 0; i < 4;i++ ){
            ...
            if (i== answerLocation){
                ...
                while (familyArrayList.get(chosenSizeRand).getTwiFamily().equals(twi1) || familyArrayList.get(chosenSizeRand).getEnglishFamily().contains("(")){
                    chosenSizeRand = random.nextInt(chosenSize);}
                answers.add(familyArrayList.get(chosenSizeRand).getTwiFamily());
        ...
        Log.i("Size", String.valueOf(familyArrayList.size()));
