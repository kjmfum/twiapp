...
public class BodypartsAdapter extends BaseAdapter implements Filterable {

    Context context;
    ArrayList<Bodyparts> originalArray , tempArray;
    //TimeAdapter.CustomFilter cf;

    public BodypartsAdapter(Context context, ArrayList<Bodyparts> originalArray) {
    ...
    public void update(ArrayList<Bodyparts> results){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        textView.setText(originalArray.get(position).getEnglishBodyparts());
        textView1.setText(originalArray.get(position).getTwiBodyparts());
