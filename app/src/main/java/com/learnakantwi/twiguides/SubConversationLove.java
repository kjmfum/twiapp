...
public class SubConversationLove extends AppCompatActivity {
    ...
    public void previous (View view){
        ...
        String c = conversationLove.get(count).getTwiConversation();
        String a = conversationLove.get(count).getEnglishConversation();
    ...
    public void next(View view){
        ...
        if (count>=conversationLove.size()-1){
            count = conversationLove.size()-1;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            if(1<5) {
                ...
                ranable = new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (repeat1) {
                            ...
                            String a = conversationLove.get(count).getTwiConversation();
                            String c = conversationLove.get(count).getEnglishConversation();
                ...
                nextButton.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        if (count <= conversationLove.size()) {
                            next(v);
                        }
                ...
                btStartSlideShow.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (unMuted){
                            ...
                            muteButton.setVisibility(View.INVISIBLE);
                            unmuteButton.setVisibility(View.VISIBLE);
                            Toast.makeText(SubConversationLove.this, "Sound Muted", Toast.LENGTH_SHORT).show();
                        }
