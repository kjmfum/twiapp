...
public class QuizSubTime extends AppCompatActivity {
    ...
    int chosenSize=(timeArrayList.size()-1);
    ...
    public void generateQuestion(){
        ...
        randomChoiceQuestion = random.nextInt(timeArrayList.size()-1);
        english1 = timeArrayList.get(randomChoiceQuestion).getEnglishTime();

        questionText.setText(english1);

        twi1 = timeArrayList.get(randomChoiceQuestion).getTwiTime();
        ...
        for (int i = 0; i < 4;i++ ){
            ...
            if (i== answerLocation){
                ...
                while (timeArrayList.get(chosenSizeRand).getTwiTime().equals(twi1) || timeArrayList.get(chosenSizeRand).getEnglishTime().contains("(")){
                    chosenSizeRand = random.nextInt(chosenSize);}
                answers.add(timeArrayList.get(chosenSizeRand).getTwiTime());
