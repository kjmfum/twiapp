...
public class FoodAdapter_real extends BaseAdapter implements Filterable {

    Context context;
    ArrayList<Food> originalArray , tempArray;
    //TimeAdapter.CustomFilter cf;

    public FoodAdapter_real(Context context, ArrayList<Food> originalArray) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        textView.setText(originalArray.get(position).getEnglishFood());
        textView1.setText(originalArray.get(position).getTwiFood());
