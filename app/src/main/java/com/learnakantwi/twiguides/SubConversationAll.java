...
import static com.learnakantwi.twiguides.SubPHomeMainActivity.conversationAll;

public class SubConversationAll extends AppCompatActivity {
    ...
    RecyclerView familyRecyclerView;
        ...
        public boolean onCreateOptionsMenu(Menu menu) {
            ...
            searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
                ...
                public boolean onQueryTextChange(String newText) {
                    ...
                    for (subConversation x: conversationAll){
        ...
        public void downloadClick () {
            ...
            for (int j = 0; j < conversationAll.size(); j++) {


                bb = conversationAll.get(j).getTwiConversation();
            ...
            if (counter == conversationAll.size()) {
                ...
                if (isNetworkAvailable()) {
                    ...
                    for (int i = 0; i < conversationAll.size(); i++) {

                        bb = conversationAll.get(i).getTwiConversation();
                        bb = PlayFromFirebase.viewTextConvert(bb);
    ...
    public void previous (View view){
        ...
        String c = conversationAll.get(count).getTwiConversation();
        String a = conversationAll.get(count).getEnglishConversation();
    ...
    public void next(View view){
        ...
        if (count>= conversationAll.size()-1){
            count = conversationAll.size()-1;
        ...
        protected void onCreate(Bundle savedInstanceState) {
                ...
                ranable = new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (repeat1) {
                            ...
                            String a = conversationAll.get(count).getTwiConversation();
                            String c = conversationAll.get(count).getEnglishConversation();
                ...
                btStartSlideShow.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (unMuted){
                            ...
                            muteButton.setVisibility(View.INVISIBLE);
                            unmuteButton.setVisibility(View.VISIBLE);
                            Toast.makeText(SubConversationAll.this, "Sound Muted", Toast.LENGTH_SHORT).show();
                        }
            ...
            subConversationAdapter subConversationAdapter = new subConversationAdapter(this, conversationAll);
