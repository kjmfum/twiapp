...
public class SubPCommonExpressionsaActivity extends AppCompatActivity implements RVCommonExpressionsAdapter.onClickRecycle{
    ...
    int count= 0;
    String textSlideshow = "Start Expressions Slideshow";
    int ArraySize = commonExpressionsAArrayList.size();
    ...
    public void previous (View view){
        ...
        String a = commonExpressionsAArrayList.get(count).getTwiCommonExpressionsA();
        String c = commonExpressionsAArrayList.get(count).getEnglishCommonExpressionsA();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ranable = new Runnable() {
            ...
            public void run() {
                ...
                if (repeat1){
                    String a = commonExpressionsAArrayList.get(count-1).getTwiCommonExpressionsA();
                    String c = commonExpressionsAArrayList.get(count-1).getEnglishCommonExpressionsA();
                    btSlideText.setText(a);
                    tvNumberWord.setText(c);
