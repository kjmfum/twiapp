...
public class SubConversationPhone extends AppCompatActivity {
    ...
    static ArrayList<subConversation> conversationPhone;
        ListView listView;
        ...
        public boolean onCreateOptionsMenu(Menu menu) {
            ...
            searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
                ...
                public boolean onQueryTextChange(String newText) {
                    ...
                    for (subConversation x: conversationPhone ){
        ...
        public void downloadClick () {
            ...
            for (int j = 0; j < conversationPhone.size(); j++) {


                bb = conversationPhone.get(j).getTwiConversation();
            ...
            if (counter == conversationPhone.size()) {
                ...
                if (isNetworkAvailable()) {
                    ...
                    for (int i = 0; i < conversationPhone.size(); i++) {

                        bb = conversationPhone.get(i).getTwiConversation();
                        bb = PlayFromFirebase.viewTextConvert(bb);
    ...
    public void previous (View view){
        ...
        String c = conversationPhone.get(count).getTwiConversation();
        String a = conversationPhone.get(count).getEnglishConversation();
    ...
    public void next(View view){
        ...
        if (count>=conversationPhone.size()-1){
            count = conversationPhone.size()-1;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            if(1<5) {
                ...
                ranable = new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (repeat1) {
                            ...
                            String a = conversationPhone.get(count).getTwiConversation();
                            String c = conversationPhone.get(count).getEnglishConversation();
                ...
                nextButton.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        if (count <= conversationPhone.size()) {
                            next(v);
                        }
                ...
                btStartSlideShow.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (unMuted){
                            ...
                            muteButton.setVisibility(View.INVISIBLE);
                            unmuteButton.setVisibility(View.VISIBLE);
                            Toast.makeText(SubConversationPhone.this, "Sound Muted", Toast.LENGTH_SHORT).show();
                        }
            ...
            subConversationAdapter subConversationAdapter = new subConversationAdapter(this, conversationPhone);
