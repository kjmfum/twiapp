...
public class RVNoticeAdapter extends RecyclerView.Adapter<RVNoticeAdapter.MyViewHolder> implements Filterable{



    Context context;
    ArrayList<Notice> originalArray , tempArray;
    ...
    public RVNoticeAdapter(Context context, ArrayList<Notice> originalArray , onClickRecycle onClickRecycle) {
    ...
    public RVNoticeAdapter(Context context, ArrayList<Notice> originalArray) {
        this.context = context;
        this.originalArray = originalArray;
        this.tempArray = new ArrayList<>(originalArray);
        this.inflater = LayoutInflater.from(context);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View view) {
            onClickRecycle.onMyItemClick(getBindingAdapterPosition(), view);
        }
    }
