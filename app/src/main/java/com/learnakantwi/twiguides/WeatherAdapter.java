...
public class WeatherAdapter extends BaseAdapter implements Filterable {
    ...
    public WeatherAdapter(Context context, ArrayList<Weather> originalArray) {
    ...
    public void update(ArrayList<Weather> results){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        textView.setText(originalArray.get(position).getWeatherEnglish());
        textView1.setText(originalArray.get(position).getWeatherTwi());
