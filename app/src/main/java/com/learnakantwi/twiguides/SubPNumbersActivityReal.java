...
public class SubPNumbersActivityReal extends AppCompatActivity implements RVNumbersAdapter.onClickRecycle{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        unmuteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                unMuted = true;
                Toast.makeText(SubPNumbersActivityReal.this, "Sound Unmuted", Toast.LENGTH_SHORT).show();
        ...
        muteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                unMuted = false;
                Toast.makeText(SubPNumbersActivityReal.this, "Sound Muted", Toast.LENGTH_SHORT).show();
        ...
        btSlideText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               // foodListView.setVisibility(View.INVISIBLE);
                ...
                Toast.makeText(SubPNumbersActivityReal.this, c, Toast.LENGTH_SHORT).show();
            }
        });
