...
public class RVCommonExpressionsAdapter extends RecyclerView.Adapter<RVCommonExpressionsAdapter.MyViewHolder> implements Filterable{
    ...
    private Filter RecycleFilter = new Filter() {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ArrayList<CommonExpressionsA> filteredList = new ArrayList<>();
            ...
            if (constraint == null || constraint.length() == 0) {
                ...
                for (CommonExpressionsA x : tempArray) {

                    if (x.getTwiCommonExpressionsA().toLowerCase().contains(filterPattern) || x.getEnglishCommonExpressionsA().toLowerCase().contains(filterPattern)) {
                        filteredList.add(x);
                    }
                }
            }
    ...
    public RVCommonExpressionsAdapter(Context context, ArrayList<CommonExpressionsA> originalArray , onClickRecycle onClickRecycle) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
            holder.tvEnglish.setText(originalArray.get(position).getEnglishCommonExpressionsA());
        holder.tvTwi.setText(originalArray.get(position).getTwiCommonExpressionsA());
    }
